          ...
          <div className="mt-3 space-y-4">
            <DataMapper
              ...
              componentProps={(following) => ({
                id: following.accountId,
                slug: following.slug,
                name: following.businessName,
                avatar: following.avatar,
                onFollowClick: () => handleFollowToggle(following.accountId),
                href: `provider/${following.slug}`,
                isFollowed: isProviderFollowed(following.accountId),
                isLoading:
